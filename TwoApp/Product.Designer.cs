            ...
            public string payment {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'payment\' in table \'Products\' is DBNull.", e);
                    }
                }
                set {
...
namespace TwoApp.ProductTableAdapters {
...
SELECT product_id, title, category_id, payment, location, country, condition, price FROM Products WHERE (product_id = @product_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TwoApp.Properties.Settings.Default.TeamCConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT product_id, title, category_id, payment, location, country, condition, pri" +
                "ce FROM dbo.Products\r\nWHERE payment LIKE @keyword";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@keyword", global::System.Data.SqlDbType.VarChar, 255, global::System.Data.ParameterDirection.Input, 0, 0, "payment", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillBy(Product.ProductsDataTable dataTable, string keyword) {
        ...
        public virtual Product.ProductsDataTable GetDataBy(string keyword) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((keyword == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
